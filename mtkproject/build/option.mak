...
INC_PATH = $(DIR_ARMINC)
MYLIB_PATH = $(PROJ_HOME)\zhdgps_rtk\ENCodeDECode.o
TEST_PATH = $(PROJ_HOME)\zhdgps_rtk\hello.lib
...
ARFLAGS = $(ARFLAGS_TMP)
#LINK flag#
LINK_FLAGS = $(LINK_FLAGS_TMP) $(SCAT_FLAG) $(OUTPUT_FLAG) $(SYM_FLAG) $(LIST_FLAG) $(LIB_PATH) $(CORE_LIB) $(MYLIB_PATH) $(TEST_PATH)

COMPLIST += zhdgps_rtk
CUS_REL_SRC_COMP += zhdgps_rtk
